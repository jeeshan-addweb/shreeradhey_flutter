...
class WoodPressOilModel {
  ...
  WoodPressOilModel({this.data, this.extensions});
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) =>
      Data(page: json["page"] == null ? null : Page.fromJson(json["page"]));

  Map<String, dynamic> toJson() => {"page": page?.toJson()};
}
...
class Section {
  ...
  factory Section.fromJson(Map<String, dynamic> json) => Section(
    ...
    faqItems:
        json["faqItems"] == null
            ? []
            : List<FaqItem>.from(
              json["faqItems"]!.map((x) => FaqItem.fromJson(x)),
            ),
    aspects:
        json["aspects"] == null
            ? []
            : List<Aspect>.from(
              json["aspects"]!.map((x) => Aspect.fromJson(x)),
            ),
    awards:
        json["awards"] == null
            ? []
  ...
  Map<String, dynamic> toJson() => {
    ...
    "faqItems":
        faqItems == null
            ? []
            : List<dynamic>.from(faqItems!.map((x) => x.toJson())),
    "aspects":
        aspects == null
            ? []
            : List<dynamic>.from(aspects!.map((x) => x.toJson())),
    "awards":
        awards == null
            ? []
...
class Aspect {
  ...
  Aspect({this.icon, this.text, this.content});

  factory Aspect.fromJson(Map<String, dynamic> json) =>
      Aspect(icon: json["icon"], text: json["text"], content: json["content"]);
...
class Award {
  ...
  Award({this.imageUrl, this.title});

  factory Award.fromJson(Map<String, dynamic> json) =>
      Award(imageUrl: json["imageUrl"], title: json["title"]);
...
class Product {
  ...
  String? price;
  String? regularPricePage;
  String? salePricePage;
  String? bestPrice;
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
    ...
    price: json["price"],
    regularPricePage: json["regularPricePage"],
    salePricePage: json["salePricePage"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "price": price,
    "regularPricePage": regularPricePage,
    "salePricePage": salePricePage,
    "bestPrice": bestPrice,
...
enum TypeName { FAQ_ITEM, PRODUCT, PRODUCT_VARIATION }

final typeNameValues = EnumValues({
  "FaqItem": TypeName.FAQ_ITEM,
...
enum DebugType { DUPLICATE_FIELD, DUPLICATE_TYPE, GRAPHQL_DEBUG }

final debugTypeValues = EnumValues({
  "DUPLICATE_FIELD": DebugType.DUPLICATE_FIELD,
  "DUPLICATE_TYPE": DebugType.DUPLICATE_TYPE,
