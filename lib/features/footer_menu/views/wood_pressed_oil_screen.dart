...
class _WoodPressedOilScreenState extends State<WoodPressedOilScreen> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      if (controller.woodPress.value == null) {
        return const Center(child: Text("No Wood Press available"));
      }

      final woodPress = controller.woodPress.value?.data?.pageBy;
      final blocks = woodPress?.blocks ?? [];
      return SingleChildScrollView(
        child: Column(
          children: [
            ...
            TitleDescriptionSection(
              title:
                  "Premium Wood-Pressed Oil: Pure, Natural, and Unparalleled",
              description:
        ...
        healthier lifestyle.''',
            ...
            TitleDescriptionSection(
              ...
              description:
                  '''When it comes to choosing the best wood-pressed oil,
        ...
        naturally.''',
            ...
            TitleDescriptionSection(
              ...
              description:
                  '''Shree Radhey's wood-pressed oils are extracted using
        ...
        pressed oil:''',
                  ...
                  SizedBox(height: MediaQuery.sizeOf(context).height * 0.02),
                  BulletPoint(
                    text: "Good for overall functioning of the body.",
                  ),
                  BulletPoint(text: "Maintains a healthy GUT."),
                  BulletPoint(text: "Rich in vitamins and minerals"),
                  BulletPoint(text: "Ideal for daily use"),
            ...
            TitleDescriptionSection(
              ...
              description:
                  '''Shree Radhey offers Naturally Extracted Wooden Cold
        ...
        makes it pure and healthy.''',
            ...
            ImageTitleDescriptionSection(
              ...
              title: "Hand Churned",
              description:
                  '''We use the traditional technique of hand churning to
        ...
        produced is incomparable with other ghee.''',
            ...
            TitleDescriptionSection(
              title:
                  "Organic Wooden Cold Pressed Oil for a Healthier Lifestyle",
              description:
