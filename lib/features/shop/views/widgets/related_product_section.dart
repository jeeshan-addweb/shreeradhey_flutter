...
class RelatedProductSection extends StatefulWidget {
  final String firstText;
  final Color firstTextColor;
  final String secondText;
  final Color secondTextColor;
  final Color sectionBgColor;
  final List<RelatedNode> products; // <-- Directly pass related products
  ...
  @override
  State<RelatedProductSection> createState() => _RelatedProductSectionState();
}

class _RelatedProductSectionState extends State<RelatedProductSection> {
  ...
  Widget build(BuildContext context) {
    final cardHeight = MediaQuery.of(context).size.width * 0.9;
